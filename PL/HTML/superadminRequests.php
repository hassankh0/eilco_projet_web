                ...
                <table border="1" class="table">
                    ...
                    if ($requests == null) {
                        ...
                        for ($i = 0; $i < count($requests); $i++) {
                            ...
                            echo
                            "<tr>"
                            . "<td>" . $requests[$i]->getId() . "</td>"
                            . "<td>" . $requests[$i]->getFullname(). "</td>"
                            . "<td>" . $requests[$i]->getAddress(). "</td>"
                            . "<td>" . $requests[$i]->getAge(). "</td>"
                            . "<td>" . $requests[$i]->getFilename(). "</td>"
                            . "<td>" . $requests[$i]->getUserId(). "</td>"
                           
                         
                            . "<td><a href='acceptRequest.php?id=" . $requests[$i]->getUserId() . "'>Accept</a></td>"
                            . "<td><a href='rejectRequest.php?id=" . $requests[$i]->getId() . "'>Reject</a></td>"
