    ...
    <body class="light-grey content" style="max-width:1600px" onload = 'start()'>
        ...
        <nav class="sidebar collapse white animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
            ...
            <div class="bar-block">
                ...
                <a href="adminPage.php" onclick="close()" class="bar-item button padding"><i class="fa fa-envelope fa-fw margin-right"></i>Messages</a>

                <a href="adminMyWork.php" onclick="close()" class="bar-item button padding"><i class="fa fa-user fa-fw margin-right"></i>My Works</a>

                <a href="usersettings.php?ref=adminPage.php" onclick="close()" class="bar-item button padding"><i class="fa fa-cog fa-fw margin-right"></i>Settings</a>
            </div>
            <div>
                ...
                <table border="1" class="table">
                    ...
                    if ($profiles == null) {
                        ...
                        for ($i = 0; $i < count($profiles); $i++) {
                            echo
                            "<tr>"
                            . "<td> Message " . $profiles[$i]->getId() . "</td>"
                            . "<td>" . $profiles[$i]->getTitle() . "</td>"
                            // . "<td>" . $messages[$i]->getFilename() . "</td>"
                            . "<td><a href='MessagesDetails.php?id=" . $profiles[$i]->getId() . "'>Details</a></td>"
                            /*   . "<td><a href='UpdateProfileForm.php?id=" . $profiles[$i]->getId() . "'>Update</a></td>" 
                              . "<td><a href='DeleteProfile.php?id=" . $profiles[$i]->getId() . "'>Delete</a></td>" */
                            . "</tr>";
                        }
                    }
                    ?>
