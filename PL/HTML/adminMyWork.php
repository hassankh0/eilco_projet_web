    ...
    <body class="light-grey content" style="max-width:1600px" onload = 'start()'>
        ...
        <nav class="sidebar collapse white animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
            ...
            <div class="bar-block">
                ...
                <a href="usersettings.php?ref=adminMyWork.php" onclick="close()" class="bar-item button padding"><i class="fa fa-cog fa-fw margin-right"></i>Settings</a>
            </div>
            <div>
        ...
        <div class="main" style="margin-left:300px">
            ...
            <div name="content" >
                ...
                <table border="1" class="table">
                    <?php
                    $profiles = getAllworks($_SESSION['loggeduser']->getId());
                    ...
                    if ($profiles == null) {
                        ...
                        for ($i = 0; $i < count($profiles); $i++) {
                            echo
                            "<tr>"
                            . "<td> Work " . $profiles[$i]->getId() . "</td>"
                            . "<td>" . $profiles[$i]->getTitle() . "</td>"
                            . "<td>" . $profiles[$i]->getBudget() . "</td>"
                            . "<td><a href='WorkDetails.php?id=" . $profiles[$i]->getId() . "'>Details</a></td>"
                            . "</tr>";
                        }
                    }
                    ?>
